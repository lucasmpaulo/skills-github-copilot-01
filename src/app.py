...
activities = {
    ...
    "Basketball Club": {
        "description": "Practice team play and compete in basketball games",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["alex@mergington.edu", "nina@mergington.edu"]
    },
    "Swimming Team": {
        "description": "Swim training sessions and local swim meets",
    ...
    "Cybersecurity Workshop": {
        "description": "Learn about digital security, ethical hacking, and best practices",
    ...
    "Visual Arts Studio": {
        "description": "Create paintings, sculptures, and multimedia art projects",
